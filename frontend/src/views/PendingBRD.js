...
import { Launch, ReplyAll } from '@material-ui/icons';
import MaterialTable from 'material-table';
import { tableIcons } from '../utils/MaterialTableConfig';
import { useHistory } from 'react-router-dom';

export default function PendingBRD(props) {
    ...
    useEffect(() => {
        ...
        {
            await axiosInstance.get('/brds/pending').then(
                result => {
            ...
            <div className="brd-container content-container">
                <div className="brd-content" style={{width: "900px"}}>
                    <MaterialTable
                        ...
                        icons={tableIcons}
                        title={<h2 style={{fontFamily: "Montserrat"}}>Pending BRDs</h2>}
                        columns={cols}
                        data={rows}  
                        actions={
                            loading === false?[{
                                icon: ReplyAll,
                                tooltip: 'Assign This BRD',
